...
To run this repo with x11 on ubuntu.
...
xhost +
```
An then copy the container id:

```
docker ps
```

Connect to the container, replacing docker-id with you id.
```
docker exec -t docker-id /bin/bash
```
